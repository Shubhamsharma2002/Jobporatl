...
import { Briefcase, Search, Star, TrendingUp, Users } from "lucide-react";
  ...
  return (
   <div className="flex flex-col min-h-screen">
      <main className="flex-1">
        ...
        <p className="text-xs text-gray-500 dark:text-gray-400">© 2025 Quick Hire Job Portal. All rights reserved.</p>
